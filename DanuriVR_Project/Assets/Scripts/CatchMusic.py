class CatchMusic(Actor.Actor):
    ...
    def OnCreate(self, uid):
        ...
        self.BackgroundSoundComponent.PropSound.SetSoundFilePath("$project/Assets/Resources/Sounds/Victory! Wild Pokemon (Pokemon Omega Ruby & Alpha Sapphire OST).mp3");
